...
5. IF Content_Draft sao chép nguyên văn từ một nguồn đạt hoặc vượt quá giới hạn được cấu hình (mặc định 50 từ liên tiếp hoặc 20% tổng số từ của Content_Draft, tùy điều kiện nào đạt trước), THEN THE Compliance_Checker SHALL đánh dấu Content_Draft là "không đạt" và nêu rõ lý do rủi ro bản quyền.
